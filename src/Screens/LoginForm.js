...
export default function LoginForm() {
  ...
  const Login = (
    <div className="w-5/6 mx-auto">
      ...
      />
      <button
        className="p-2 rounded-lg bg-gray-900 uppercase tracking-wide font-bold text-lg hover:bg-blue-600 focus:bg-blue-600 text-gray-300 sm:w-1/3 w-full mb-2"
        onClick={() => null}
      >
        Let's Go!
      </button>
  ...
  const Register = (
    <div className="w-5/6 mx-auto">
      ...
      <input
        ...
        className="w-full p-2 text-gray-100 bg-gray-700 rounded-lg mt-4"
      />
      <input
        type="text"
        placeholder="Enter Username..."
